...
import { fetchRandomQuote, getCorrectAns, getRandomAnswersArray } from './content/trivia'
import { getRandomTitle } from './content/titles'
import { getRandomDeath } from './content/deaths'
//TO DO: check to make sure that functions are properly wired through services file to front pages!
